...
@pytest.fixture
def fx_openapi_object__required(fx_info_object_required, fx_paths_object__required) -> dict:
    return {'openapi': '3.2.0', 'info': fx_info_object_required, 'paths': fx_paths_object__required}
